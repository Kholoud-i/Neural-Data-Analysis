...
Neuroscience -  hc3 dataset (Spikes, Local Field Potential) 
...
## The Analysis
Skills involved: Signal Processing; Statistical Analysis; MATLAB Programming

Worked with Collaborative Research in Computational Neuroscience hc3 dataset (Spikes, LFP)

Utilized MATLAB to build a bandpass filter to detect ripples from LFP
